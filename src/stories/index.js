...
storiesOf('DayMatch', module)
  .add('basic', () => <DayMatch match={{difference: 7, matches: [{   score: '5:4',   difference: 8 }, {   score: '3:5',   difference: 8 }], winner_team: {   player1: {     name: 'Stephan',     image: 'https://bit.ly/2qkiob5'   },   player2: {     name: 'Klaus',     image: 'https://bit.ly/2qkiob5'   } },  loser_team: {   player1: {     name: 'Peter',     image: 'https://bit.ly/2qkiob5'   },   player2: {     name: 'Max',     image: 'https://bit.ly/2qkiob5'   } }}}/>)
